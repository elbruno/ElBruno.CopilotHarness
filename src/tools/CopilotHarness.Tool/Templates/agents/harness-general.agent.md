...
description: "Orchestrator agent for development workflows. Routes to specialized local-model sub-agents for launch, GitHub, debug, database, test, docs, and deploy tasks. Uses the configured Copilot cloud model for reasoning."
tools:
  - codebase
  - fetch
  - findTestFiles
...
- For launch/GitHub/debug/db/test/docs/deploy tasks: name the sub-agent and route explicitly.
